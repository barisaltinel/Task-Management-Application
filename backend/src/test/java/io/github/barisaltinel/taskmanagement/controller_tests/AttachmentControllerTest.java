...
class AttachmentControllerTest {
    ...
    void shouldReturnAllAttachments() {
        ...
        ResponseEntity<List<ApiDtos.AttachmentResponse>> response = attachmentController.getAllAttachments();
    ...
    void shouldReturnAttachmentById() {
        ...
        ResponseEntity<ApiDtos.AttachmentResponse> response = attachmentController.getAttachmentById(1L);
