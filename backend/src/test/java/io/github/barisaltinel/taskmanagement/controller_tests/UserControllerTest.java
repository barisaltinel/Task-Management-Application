...
class UserControllerTest {
    ...
    void shouldCreateUser() {
        ApiDtos.UserCreateRequest request =
                new ApiDtos.UserCreateRequest("John Doe", "john@example.com", "plainPassword", "TEAM_MEMBER");
    ...
    void shouldUpdateUser() {
        ApiDtos.UserUpdateRequest request =
                new ApiDtos.UserUpdateRequest("John Doe", "john@example.com", "plainPassword", "TEAM_MEMBER");
