...
class AttachmentIntegrationTest {
    ...
    void shouldFailToUploadAttachmentWithoutAuthentication() throws Exception {
        MockMultipartFile file =
                new MockMultipartFile("file", "unauthorized.txt", "text/plain", "Unauthorized user".getBytes());
    ...
    void shouldFailToUploadFileToInvalidTask() throws Exception {
        MockMultipartFile file =
                new MockMultipartFile("file", "invalid-task-file.txt", "text/plain", "Invalid Task".getBytes());
    ...
    void shouldSoftDeleteAttachment() throws Exception {
        ...
        mockMvc.perform(delete("/api/attachments/" + attachment.getId())).andExpect(status().isNoContent());

        Attachment deletedAttachment = attachmentRepository
