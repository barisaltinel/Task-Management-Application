...
public class ProjectController {
  ...
  public ResponseEntity<List<ApiDtos.ProjectResponse>> getAllProjects() {
    return ResponseEntity.ok(
        projectService.getAllProjects().stream().map(ApiMapper::toProjectResponse).toList());
  }
  ...
  public ResponseEntity<ApiDtos.ProjectResponse> createProject(
    ...
    Project createdProject =
        projectService.create(ApiMapper.toProject(request), request.teamMemberIds());
  ...
  public ResponseEntity<ApiDtos.ProjectResponse> updateProject(
    ...
    Project updatedProject =
        projectService.update(id, ApiMapper.toProject(request), request.teamMemberIds());
